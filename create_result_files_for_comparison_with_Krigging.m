...
for ksim = 1:Nsim
    ...
    % clearvars -except B_theor_all  B_pred_all B_krig_all B_sim_all  ksim Nsim Npts data_dir_root Minterp B_reka f predictions label_dir low_res_dir
...
if flag == 1
    res_file = ['P:\Results_tests\results_test_20traj_MAGDL1_incl_Krigging_',sitecase];
else
    res_file = ['P:\Results_tests\results_test_20traj_MAGDL2_KNN_',sitecase];
end

% save(res_file,'B_theor_all'  ,'B_pred_all'  ,'B_sim_all', 'B_krig_all' )
